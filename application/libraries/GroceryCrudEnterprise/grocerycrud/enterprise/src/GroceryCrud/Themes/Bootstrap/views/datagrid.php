<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.6.5fd6d56.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.6.5fd6d56' . $minify_or_not . '.js');
