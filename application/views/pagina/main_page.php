    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Contribui com nossa paróquia</h1>
        ...
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <div class="form-row">
            <div class="col-12 col-md-12 mb-2 mb-md-0">
              <button type="button" class="btn btn-lg btn-danger">Fazer um doação</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="features-icons bg-light text-center" id="doacao">
    <div class="container">
      <h2 class="mb-5">Como fazer doação</h2>
      <div class="row">
        <div class="col-lg-4">
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="<?= base_url("assets/uploads/files/sobre1.jpg") ?>" alt="">
            <h5>Margaret E.</h5>
        ...
        <div class="col-lg-4">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            <img class="img-fluid rounded-circle mb-3" src="<?= base_url("assets/uploads/files/sobre.jpg") ?>" alt="">
            <h5>Fred S.</h5>
