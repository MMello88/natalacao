...
insert  into `tbl_projeto_menu`(`id_projeto_menu`,`id_projeto`,`menu`,`url`,`ativo`,`ordem`) values (1,1,'Paginas','admin/paginas','Ativo',1),(2,1,'Objeto da Pagina','admin/configuracao','Ativo',2),(3,2,'Projetos','admin/projeto','Ativo',1),(4,2,'Menu','admin/menu','Ativo',2);
