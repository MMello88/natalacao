...
insert  into `tbl_projeto_menu`(`id_projeto_menu`,`id_projeto`,`menu`,`url`,`ativo`,`ordem`,`id_projeto_pai`) values (1,1,'Paginas','admin/paginas','Ativo',1,7),(2,1,'Objeto da Pagina','admin/configuracao','Ativo',2,7),(3,2,'Configurações do Projeto','proj','Ativo',0,NULL),(4,2,'Menu','admin/menu','Ativo',2,3),(6,2,'Projetos','admin/projeto','Ativo',1,3),(7,1,'Configurações de Paginas','cfg','Ativo',0,NULL);
